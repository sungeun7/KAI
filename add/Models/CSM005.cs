namespace MACRO_WMS.Models
{
    ...
    public class CSM005_ProdListItem
    {
    ...
    public class CSM005_ReqListItem
    {
        ...
        public List<CSM005_ProdListItem> ProdList { get; set; }

        public CSM005_ReqListItem()
        {
            ProdList = new List<CSM005_ProdListItem>();
        }
    }
    ...
    public class CSM005
    {
        ...
        public List<CSM005_ReqListItem> ReqList { get; set; }

        public CSM005()
        {
            ReqList = new List<CSM005_ReqListItem>();
        }
    }
}